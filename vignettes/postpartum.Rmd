...
p1 <- rdata |>
  ...
  mutate(taxon = factor(taxon, levels = c("Lactobacillus", "L.iners", "L.jensenii", "Atopobium", "Prevotella_6", "Porphyromonas"))) |>
...
p2 <- values_df |>
  mutate(
    value = rank(value) / n(),
    taxon = factor(taxon, levels = c("Lactobacillus", "L.iners", "L.jensenii", "Atopobium", "Prevotella_6", "Porphyromonas"))
  )|>
  interaction_hm(taxa = focus_taxa, "BirthControlYesNo", -1, width = 14) +
...
ggsave("postpartum-combined.png", width = 10, height = 4)
```
